      ...
      'plant-parts': {
        ...
        od: {
          ...
          steps: [
            ...
            '📋 ବାମ ପର୍ଶ୍ୱରେ ଗଛର ଅଂଶଗୁଡ଼ିକ ପାଇଁ ଲେବଲ୍ ଦେଖାଯାଏ',
            ...
            <CardContent className="p-6 md:p-8">
              ...
              <div className="space-y-3">
                {gameInstructions?.steps.map((step: string, index: number) => (
                  ...
                  >
                    <span className="flex-shrink-0 w-6 h-6 bg-linear-to-r from-green-500 to-emerald-500 text-white rounded-full flex items-center justify-center text-sm">
                      {index + 1}
                    </span>
