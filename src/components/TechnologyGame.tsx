      ...
      "parts-puzzle": {
        ...
        hi: {
          ...
          steps: [
            ...
            "📍 पुर्जों में शामिल हैं: मॉनिटर, सीपीयू, कीबो्ड, माउस",
        ...
        od: {
          ...
          steps: [
            ...
            "📍 ଅଂଶଗ���ଡ଼ିକ ଅନ୍ତର୍ଭୁକ୍ତ: ମନିଟର, ସିପିୟୁ, କୀବୋର୍ଡ, ମାଉସ୍",
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <Card className="border-2 shadow-xl">
            ...
            <CardContent className="p-6 md:p-8">
              ...
              <div className="space-y-3">
                {gameInstructions?.steps.map(
                  (step: string, index: number) => (
                    ...
                    >
                      <span className="flex-shrink-0 w-6 h-6 bg-linear-to-r from-indigo-500 to-purple-500 text-white rounded-full flex items-center justify-center text-sm">
                        {index + 1}
                      </span>
              ...
              <Button
                onClick={() =>
                  setCurrentGame(fullGameId as GameType)
                }
                ...
                >
                  ...
                  <CardContent className="text-center space-y-2">
                    ...
                    <Button
                      onClick={() => {
                        const howToId =
                          game.id === "binary-match"
                            ? "how-to-binary"
                            : game.id === "keyboard-ninja"
                              ? "how-to-keyboard"
                              : game.id === "parts-puzzle"
                                ? "how-to-parts"
                                : "how-to-internet";
  ...
  create() {
    ...
    this.feedback = this.add
      .text(
        width / 2,
        520,
        `Round: ${this.rounds}/${this.maxRounds}`,
        {
          fontSize: "22px",
          color: "#ffd54f",
        },
  ...
  private checkAnswer() {
    ...
    if (value === this.target) {
      ...
      this.feedback.setText(
        `✅ Correct! Round: ${this.rounds}/${this.maxRounds}`,
      );
      this.tweens.add({
