...
const teamMembers = [
  ...
  { name: "Raasikh", color: "from-red-400 to-pink-500" },
  { name: "Burhan", color: "from-green-400 to-emerald-500" },
];
...
export function AboutUs({
  ...
  className="mb-12"
>
  <div className="grid grid-cols-3 gap-6 mb-8 max-w-md mx-auto justify-items-center">
